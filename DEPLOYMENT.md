...
Once deployed, copy the Render service URL (e.g., `https://clinic-backend.onrender.com`).
...
5. Expand the **Environment Variables** section and add:
   ...
   - Value: Your Render URL with `/api` appended (e.g., `https://clinic-backend.onrender.com/api`).
6. Click **Deploy**.
