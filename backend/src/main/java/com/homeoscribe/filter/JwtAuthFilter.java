...
import com.homeoscribe.service.JwtService;
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                if (jwtService.isTokenValid(jwt)) {
                    ...
                    String normalizedRole = resolveRole(role);

                    SimpleGrantedAuthority authority = new SimpleGrantedAuthority("ROLE_" + normalizedRole);

                    // Reconstruct UserDetails in memory without hit to MongoDB
                    UserDetails userDetails = org.springframework.security.core.userdetails.User.builder()
                            .username(userEmail)
                            .password("") // Empty password for stateless authentication
